...
kg/DepartureLayer/2.0.0/store
kg/DepartureLayer/2.0.0/dialog
kg/DepartureLayer/2.0.0/toptip
kg/DepartureLayer/2.0.0/index
 ...
 *   更新 tabsize 按照规范
 */
KISSY.add('kg/DepartureLayer/2.0.0/store',function(S) {
	var api               = {};
	var win               = window;
...
KISSY.add('kg/DepartureLayer/2.0.0/dialog',function (S, Base, Node) {
...
KISSY.add('kg/DepartureLayer/2.0.0/toptip',function (S, Base, Node) {
  function Toptip () {}
  var props = {
    render: function (config) {
      var self = this;
 ...
 * @example
 *
 *    KISSY.use('kg/DepartureLayer/1.0/index', function(S,BK){
 *           var killer = new BK({   
 *               browser : [
 *                 { 
 *                   browser:'ie', 
 ...
 * 
 */
KISSY.add('kg/DepartureLayer/2.0.0/index',function (S, UA, Store, Dialog, Toptip) {
  // This package path
